      ...
      <div className="flex h-screen w-full overflow-hidden">
        ...
        <div className="hidden md:block w-1/2 bg-gray-900 relative">
          ...
          <div className="absolute top-6 left-6 bg-gray-800/70 px-5 py-3 rounded-full flex items-center space-x-2">
            ...
            <span className="text-gray-300 text-sm font-medium">Melian Signup</span>
          </div>
        ...
        <div className="w-full md:w-1/2 bg-white flex items-center justify-center p-8">
          <div className="max-w-md w-full space-y-8 text-center">
            <div className="p-6 bg-green-50 rounded-xl">
              ...
              <Link href="/signin" className="inline-block mt-4 text-indigo-600 hover:text-indigo-500">
                Return to sign in
              </Link>
            </div>
          </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/signin" className="font-medium text-gray-600 hover:text-gray-900">
